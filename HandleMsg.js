...
const errorurl = 'https://f.top4top.io/p_2215957070.jpg'
const errorurl2 = 'https://f.top4top.io/p_2215957070.jpg'
...
module.exports = HandleMsg = async (urbae, message) => {
	try {
		...
		// [IDENTIFY]
		const ownerNumber = "62881036690566@c.us"
		const errorImg = "https://ibb.co/RHxcNw9"
      ...
      if (chats == 'Terimakasih'){
          urbae.reply(from, 'Iya sama-sama..', id)
      }
      if (chats == 'terimakasih'){
          urbae.reply(from, 'Iya sama-sama..', id)
      }
      ...
      if (chats == '#18+'){
          urbae.reply(from, '*Demi kenyamanan bersama,*\n*Maaf menu ini telah di hapus!.*', id)
      }
      if (chats == '#18+2'){
          urbae.reply(from, '*Demi kenyamanan bersama,*\n*Maaf menu ini telah di hapus!.*', id)
      }
      ...
      if (chats == 'P'){
          urbae.sendPtt(from, './media/nani-kore.mp3', id)
      }
      if (chats == 'p'){
          urbae.sendPtt(from, './media/nani-kore.mp3', id)
      }
      ...
      if (chats == 'Bot'){
          urbae.sendPtt(from, './media/hai.mp3', id)
      }
      if (chats == 'bot'){
          urbae.sendPtt(from, './media/hai.mp3', id)
      }
      if (chats == 'kontol'){
          urbae.sendPtt(from, './media/astg.mp3', id)
      }
      if (chats == 'Tai'){
          urbae.sendPtt(from, './media/astg.mp3', id)
      }
      ...
      if (chats == 'bacot') {
          urbae.sendPtt(from, './media/song.mp3', id)
      }
      if (chats == 'kntl') {
          urbae.sendPtt(from, './media/astg.mp3', id)
      }
     ...
     if (chats == '#rhentai'){
      ...
      if (chats == 'gajelas'){
          urbae.sendPtt(from, './media/bakaa.mp3', id)
      }
      if (chats == 'Gajelas'){
          urbae.sendPtt(from, './media/bakaa.mp3', id)
      }
      ...
      if (chats == 'hai'){
		...
		if (mentionedJidList.includes(ownerNumber)) { /*Y'ALL CAN CUSTOM THIS WHATEVER YOU WANT!*/
			...
			urbae.reply(from, 'ngapain tag BloodSword?\npc aja kali sabii', id).then(() => {
		...
		const mess = {
			...
			wait: '*[ WAIT ]* _Sedang di proses⏳ silahkan tunggu sebentar!_\n\n```BloodSword```',
			...
			prem: `Mau Jadi User Premium ?? Chat Owner\n\nwa.me/${ownerNumber.replace('@c.us', '')}\n\n~BloodSword`,
			error: {
...
function isLimit(id){
                    ...
                    for (let i of limit){
                        if(i.id === id){
                            ...
                            if (limits >= limitCount) {
                                found = true;
                                urbae.reply(from, `Perintah BOT anda sudah mencapai batas, coba esok hari :)`, id)
                                return true;
                            }else{
                                limit
                                found = true;
       ...
       function limitAdd (id) {
		...
		const menupict = "https://f.top4top.io/p_2215957070.jpg"
...
case prefix + 'resetlimit':
                if (!isOwnerB) return urbae.reply(from, `Khusus owner` , id) 
	     {
                limit.splice(chat.id)
                fs.writeFileSync('./settings/limit.json', JSON.stringify(limit))
                await urbae.reply(from, `Sudah kak` , id)
            }
break
case prefix + 'limit':
            var found = false
            ...
            for(let lmt of limidat){
                if(lmt.id === pengirim){
                    ...
                    if(limitCounts <= 0) return urbae.reply(from, `Limit request anda sudah habis\n\n_Note : Jika ingin menambah limit silahkan chat owner`, id)
                    urbae.reply(from, `Sisa limit request anda tersisa : *${limitCounts}*\n\n_Note : Jika ingin menambah limit silahkan chat owner`, id)
                    urbae.sendContact(ownerNumber , id)
                    found = true
                }
            }
            if (found === false){
                ...
                urbae.reply(from, `Sisa limit request anda tersisa : *${limitCount}*\n\n_Note : Jika ingin menambah limit silahkan chat owner`, id)
            }
            break
				case prefix + 'getpic':
				...
				case prefix + 'tnc':
					...
					break
				case prefix + 'help':
					const bots = `Hi ${pushname}, this is BloodSword Bot, to find out the commands menu, type *${prefix}menu* , *${prefix}p*`
					await urbae.reply(from, bots, id)
					break
				case prefix + 'rbts':
					if (isLimit(serial)) return urbae.reply(from, `_Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}limit Untuk Mengecek Kuota Limit Kamu_`, id)        
					
					urbae.reply(from, mess.wait, id)
					urbae.sendFileFromUrl(from, `https://api.dapuhy.xyz/api/randomimage/batues?apikey=${dapuhyapi}`, 'img.jpg', 'nehh', id)
					break
				case prefix + 'rvidanime':
					if (isLimit(serial)) return urbae.reply(from, `_Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}limit Untuk Mengecek Kuota Limit Kamu_`, id)        
					
					urbae.reply(from, mess.wait, id)
					urbae.sendFileFromUrl(from, `https://api.dapuhy.xyz/api/anime/storyanime?apikey=${dapuhyapi}`, 'anime.mp4', '', id)
					break
				case prefix + 'rexo':
					if (isLimit(serial)) return urbae.reply(from, `_Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}limit Untuk Mengecek Kuota Limit Kamu_`, id)        
					
					urbae.reply(from, mess.wait, id)
					urbae.sendFileFromUrl(from, `https://api.dapuhy.xyz/api/randomimage/exontol?apikey=${dapuhyapi}`, 'img.jpg', 'nehh', id)
					break
				case prefix + 'rblackpink':
					if (isLimit(serial)) return urbae.reply(from, `_Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}limit Untuk Mengecek Kuota Limit Kamu_`, id)        
					
					urbae.reply(from, mess.wait, id)
					urbae.sendFileFromUrl(from, `https://api.dapuhy.xyz/api/randomimage/blekpink?apikey=${dapuhyapi}`, 'blackpink.jpg', '', id)
					break
...
case prefix + 'tutorialmp4':
            await urbae.sendText(from, menuId.textMp4())
            break
case prefix + 'hapusiklan':
            await urbae.sendText(from, menuId.textIklan())
            break
case prefix + 'hematkuota':
            await urbae.sendText(from, menuId.textKuota())
            break
case prefix + 'ytdownload':
            await urbae.sendText(from, menuId.textYt())
            break
case prefix + 'themegoogle':
            await urbae.sendText(from, menuId.textCh())
            break
case prefix + 'gombalin':
            await urbae.sendText(from, menuId.textGombal())
            break
case prefix + 'igdownload':
            await urbae.sendText(from, menuId.textIg())
            break
case prefix + 'sadapwa':
            await urbae.sendText(from, menuId.textWa())
            break
case prefix + 'lacakhp':
            await urbae.sendText(from, menuId.textHp())
            break
				case prefix + 'caklontong':
					...
					if (!isGroupMsg) return urbae.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
					try {
						const resp = await axios.get('https://zekais-api.herokuapp.com/caklontong?apikey=' + zekais)
						if (resp.data.error) return urbae.reply(from, resp.data.error, id)
						const anm2 = `➸ Soal : ${resp.data.soal}\n\n➸ Clue : ${resp.data.clue}`
						const jwban = `➸ Jawaban : ${resp.data.jawaban}\n\n➸ Deskripsi : ${resp.data.detail}`
...
case prefix + 'jabwaltvnow':
   const jadwalNow = await fetch(`http://docs-jojo.herokuapp.com/api/jadwaltvnow`)
            ...
            urbae.reply(from, `Jam : ${jdn.result.jam}\n\nJadwalTV : ${jdn.result.jadwalTV}join\n\nBy : BloodSword\n`, id)
            break


            case prefix + 'infonomor':
case prefix + 'infonomer':
if (args.length == 0) return urbae.reply(from, 'Nomornya mana??', id)
await urbae.reply(from, mess.wait, id)       
 const nomro = body.slice(11)
      ...
      urbae.reply(from, `➸ *Nomor* : ${nmro.nomor} \n➸ *Internasional* : ${nmro.international} \n➸ *Operator* : ${nmro.op}\n\nBy : BloodSword`, id)
     break 
...
case prefix + 'antivirtek':
            ...
            if (!isGroupAdmins) return urbae.reply(from, 'Gagal, perintah ini hanya dapat digunakan oleh admin grup!', id)
            			return await urbae.reply(from, `\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSword\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\\n\nBy : BloodSwordn\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nBy : BloodSword\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nhttps://youtube.com/c/BloodSword FITURE OFFICIAL\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n`, id)
			break
...
case prefix + 'bjanime':
	if (isLimit(serial)) return urbae.reply(from, `_Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}limit Untuk Mengecek Kuota Limit Kamu_`, id)        
					...
					try {
						urbae.reply(from, mess.wait, id)
						axios.get('https://zenzapi.xyz/api/anime/nsfw/bj?apikey=${zenzapi}', { responseType: 'arrayBuffer' }).then(res => {
							urbae.sendImage(from, res.data, 'bj.gif', 'Sange kok sama gambar:v');
  	...
  	if (isLimit(serial)) return urbae.reply(from, `_Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}limit Untuk Mengecek Kuota Limit Kamu_`, id)                   
       if (!isNsfwOn) return urbae.reply(from, mess.nsfwnoton, id)
				...
				case prefix + 'rhentai':
					...
					urbae.reply(from, mess.wait, id);
					axios.get('https://nekos.life/api/v2/img/Random_hentai_gif').then(res => {
						urbae.sendFileFromUrl(from, res.data.url, 'sange kok pake gambar');
			...
			case prefix + 'memes':
				if (isLimit(serial)) return urbae.reply(from, `_Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}limit Untuk Mengecek Kuota Limit Kamu_`, id)        
					...
					urbae.sendFileFromUrl(from, res.data.result.url, 'Aowkakaka', id);
					});
					break
case prefix + 'aesthetic':
	if (isLimit(serial)) return urbae.reply(from, `_Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}limit Untuk Mengecek Kuota Limit Kamu_`, id)        
					
    urbae.sendFileFromUrl(from, `https://api.lolhuman.xyz/api/random/estetic?apikey=${lolhuman}`, 'aesthetic.png', '', id)
  break
...
const cuacaq = body.slice(7)
            ...
            await urbae.reply(from, cuacap, id)
            .catch(() => {
                urbae.reply(from, 'ada yang error!', id)
            })
            break
				case prefix + 'doaharian':
					...
					urbae.reply(from, mess.wait, id)
					try {
						const dataplaw = await axios.get(`https://api.dapuhy.xyz/api/islam/doaharian?apikey=${dapuhyapi}`)
						const dataplax = dataplaw.data.result
						let harian = `*「 DOA HARIAN 」*`
						for (let i = 0; i < dataplax.data.length; i++) {
							harian += `\n─────────────────\n\n• *Judul Doa:* ${dataplax.data.result[i].title}\n• *Arab:* ${dataplax.data.result[i].arabic}\n• *Latin:* ${dataplax.data.result[i].latin}\n• *Arti:* ${dataplax.data.result[i].translation}\n\n`
						}
				...
				case prefix + 'infoapk':
					...
					axios.get(`https://api.dapuhy.xyz/api/search/playstore-info?id=${idaplikasi}&apikey=${dapuhyapi}`)
						.then(async (res) => {
				...
				case prefix + 'sgif':
					...
					break
				case prefix + 'startgif': //By: BloodSword
					if (isMedia && type === 'video' || mimetype === 'sticker/gif') {
						try {
							urbae.reply(from, mess.wait, id)
...
case prefix + 'translate2':
		     if (args.length == 0) return urbae.reply(from, `Untuk menggunakan translate pada sebuah kata gunakan ${prefix}translate2 [kode bahasa]\nContoh: ${prefix}translate2 id|my name is udin`, id)
			const csuway1 = arg.split('|')[0]
				...
				case prefix + 'neonime':
					...
					break
				case prefix + 'brainly':
					        if (args.length == 0) return urbae.reply(from, `Untuk mencari jawaban dari brainly\nUsage : ${prefix}brainly2 NKRI`, id)
        rugaapi.brainly(body.slice(9))
        .then(async(res) => {
            const baik = `*Soal :* ${res.result.question} *Hasil :* ${res.result.answer}\n\nBy : BloodSword`
            urbae.reply(from, baik, id)
        })
        .catch(() => {
        ...
        break
				...
				case prefix + 'quotemaker':
					if (args.length === 0) return urbae.reply(from, `Kirim perintah *#quotemaker2 |gagal move on|BloodSword*`, id)
            argz = body.trim().split('|')
            if (argz.length >= 2) {
                urbae.reply(from, `Wait sedang diproses...`, id)
                const teksq1 = argz[1]
                const teksq2 = argz[2]
                if (teksq1 > 30) return urbae.reply(from, '*Masukan text minimal 30 huruf!', id)
                if (teksq2 > 30) return urbae.reply(from, '*Masukan Text*\n_Maksimal 30 huruf!_', id)
                         urbae.sendFileFromUrl(from, `https://api.xteam.xyz/quotemaker?text=${teksq1}&wm=${teksq2}&APIKEY=c4d24c6bef1dac73`)
            } else {
                await urbae.reply(from, `Wrong Format!\n[❗] Kirim perintah *#quotemaker2 |gagal move on|BloodSword*`, id)
            }
 break
				...
				case prefix + 'shitposting':
					urbae.reply(from, mess.wait, id)
					urbae.sendFileFromUrl(from, `https://api.xteam.xyz/shitpost?APIKEY=c4d24c6bef1dac73`, 'gelap.mp4', '', id)
						.catch(() => {
				...
				case prefix + 'emojistiker':
					...
					urbae.sendStickerfromUrl(from, `https://zekais-api.herokuapp.com/emoji?unicode=${emoji}&apikey=${zekais}`, StickerMetadata)
						.catch((err) => {
							console.log(err)
					...
					break
				case prefix + 'qotd':
					axios.get(`https://api.dapuhy.xyz/api/fun/quoteslucu?apikey=${dapuhyapi}`)
						.then(async (res) => {
							if (res.data.status == false) return urbae.reply(from, 'Rest Api sedang error', id)
				...
				case prefix + 'glitch':
					...
					if (args.length === 0) return urbae.reply(from, `Kirim perintah *${prefix}glitch [ Teks1|Teks2 ]*, contoh *${prefix}glitch |BloodSword|Dev Thoriq*`, id)
					try {
						urbae.reply(from, mess.wait, id)
				...
				case prefix + 'pensilart':
					if (isMedia || isImage || isQuotedImage) {
						...
						const beimgbb = await axios.get(`https://videfikri.com/api/imgbb/?urlgbr=${uploadimg}&title=BloodSword`)
				...
				case prefix + 'stickernobg':
					if (isMedia || isImage || isQuotedImage) {
						...
						urbae.sendImageAsSticker(from, heynobg, { author: '@BloodSword', pack: 'BloodSword', removebg: true })
							.catch((err) => {
								console.log(err)
								urbae.reply(from, err.message, id)
							})
				...
				case prefix + 'asupan6':
					...
					urbae.sendText(from, 'Error ngab!')
				...
				case prefix + 'asupanukhty':
					...
					urbae.reply(from, mess.wait, id)
					await urbae.sendFileFromUrl(from, `https://api.dapuhy.xyz/api/asupan/asupanukhty?apikey=${dapuhyapi}`, 'vid.mp4', '', id)
					break
				case prefix + 'asupan3':
					if (isLimit(serial)) return urbae.reply(from, `_Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}limit Untuk Mengecek Kuota Limit Kamu_`, id)        
					
					urbae.reply(from, mess.wait, id)
					await urbae.sendFileFromUrl(from, `https://api.dapuhy.xyz/api/asupan/asupanbocil?apikey=${dapuhyapi}`, 'asupan.mp4', '', id)
					break
				case prefix + 'asupan2':
					if (isLimit(serial)) return urbae.reply(from, `_Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}limit Untuk Mengecek Kuota Limit Kamu_`, id)        
					
					urbae.reply(from, mess.wait, id)
					await urbae.sendFileFromUrl(from, `https://api.dapuhy.xyz/api/asupan/asupansantuy?apikey=${dapuhyapi}`, 'vid.mp4', '', id)
					break
				case prefix + 'asupan':
					if (isLimit(serial)) return urbae.reply(from, `_Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}limit Untuk Mengecek Kuota Limit Kamu_`, id)        
					
					urbae.reply(from, mess.wait, id)
					await urbae.sendFileFromUrl(from, `https://api.dapuhy.xyz/api/asupan/asupan?apikey=${dapuhyapi}`, 'vid.mp4', '', id)
					break
				/*case prefix+'ranal':
				urbae.reply(from, mess.wait, id)
				...
				case prefix + 'ghea':
					...
					urbae.reply(from, mess.wait, id)
					await urbae.sendFileFromUrl(from, `https://api.dapuhy.xyz/api/asupan/asupanghea?apikey=${dapuhyapi}`, 'ghea.mp4', '', id)
					break
				...
				case prefix + 'jadwaltv':
					...
					urbae.reply(from, mess.wait, id)
					try {
						const fortv = await fetch(`https://api.dapuhy.xyz/api/others/jadwaltv?channel=${tvsearch}&apikey=${dapuhyapi}`)
						const tojson = await fortv.json()
						const { data } = await tojson
						let betv = `*「 JADWAL TV ${tvsearch} 」*\n`
						for (let i = 0; i < data.result.length; i++) {
							betv += `\nJam : ${data.result[i].jam}\nTayangan : ${data.result[i].tayang}\n`
						}
				...
				case prefix + 'ecchi':
					urbae.reply(from, mess.wait, id)
					const echhiurl = await axios.get(`https://api.dapuhy.xyz/api/kartun/ecchi?apikey=${dapuhyapi}`)
					const ecchidata = ecchiurl.data.result
					
					let ecchitext = `*「 GENRE ECCHI 」*\n`
					for (let i = 0; i < ecchidata.length; i++) {
						ecchitext = `\n─────────────────\n\n*•Judul:* ${ecchidata[i].title}\n*•Status:* ${ecchidata[i].status}\n*•Url:* ${ecchidata[i].url}\n`
					}
					await urbae.sendFileFromUrl(from, ecchidata[0].thumb, 'thumb.jpg', ecchitext, id)
						.catch(err => {
							console.log(err)
							urbae.reply(from, err.message, id)
						})
				...
				case prefix + 'faktaunik':
					...
					urbae.reply(from, mess.wait, id)
					fetchJson('https://zekais-api.herokuapp.com/fakta?apikey=${zekais}')
						.then(async (res) => {
							urbae.reply(from, res.data.result, id)
								.catch(err => {
									console.log(err)
				...
				case prefix + 'manga':
					...
					urbae.reply(from, mess.wait, id)
					try {
						const mangax = await axios.get(`https://api.dapuhy.xyz/api/manga/klikmanga?query=${mangasearch}&apikey=${dapuhyapi}`)
				...
				case prefix + 'tebakanime':
					const animesoal = await fetchJson(`https://zekais-api.herokuapp.com/tebakanime?apikey=${zekais}`)
					if (animesoal.status == false) return urbae.reply(from, 'Lagi error', id)
					const imageanime = animesoal.data.image
					const jawabananime = `Result : ${animesoal.data.name}\nDeskripsi : ${animesoal.data.desc}`
				...
				case prefix + 'bbcindo':
					...
					urbae.reply(from, mess.wait, id)
					const bbcurl = await axios.get(`https://api.dapuhy.xyz/api/berita/cnn?apikey=${dapuhyapi}`)
				...
				case prefix + 'cnnindo':
					...
					urbae.reply(from, mess.wait, id)
					const cnnapi = await axios.get(`https://api.dapuhy.xyz/api/berita/cnn?apikey=${dapuhyapi}`)
				...
				case prefix + 'appstore':
					...
					urbae.reply(from, mess.wait, id)
					const appslink = await axios.get(`https://api.dapuhy.xyz/api/search/playstore?query=${apps}&apikey=${dapuhyapi}`)
					const appsdata = appslink.data
					const appstores = appsdata.result
					let apptext = `*「 App Store 」*\n`
					for (let i = 0; i < appstores.length; i++) {
						apptext += `\n─────────────────\n\n• *Nama Apk:* ${appstores[i].title}\n• *Deskripsi:* ${appstores[i].description}\n• *Url:* ${appstores[i].link}\n• *Ranting:* ${appstores[i].ranting}\n`
					}
				...
				case prefix + 'cekjodoh':
					...
					rugaapi.cekjodoh(args[0], args[1])
						.then(async (res) => {
							await urbae.sendFileFromUrl(from, `${res.data.result.thumb}`, '', `${res.text}`, id)
						})
					break
...
case prefix + 'motivasi':
	if (isLimit(serial)) return urbae.reply(from, `_Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}limit Untuk Mengecek Kuota Limit Kamu_`, id)        
					...
					urbae.reply(from, mess.wait, id)
					axios.get(`https://zenzapi.xyz/api/motivasi?apikey=${zenzapi}`)
						.then(async (res) => {
							const motiva = `*Motivasi:* ${res.data.result.message}`
							await urbae.reply(from, motiva, id)
								.catch(err => {
									urbae.reply(from, 'Maaf, sistem sedang error', id)
								})
						})
				...
				case prefix + 'cersex':
					...
					rugaapi.cersex()
						.then(async (res) => {
							await urbae.sendFileFromUrl(from, res.Thumb, 'image.jpg', `- Judul: ${res.Judul}\nCerita : ${res.Cerita}`, id)
						})
						.catch(err => {
							console.log(err)
							urbae.reply(from, err.message, id)
				...
				case prefix + 'puisi':
					...
					.then(async (res) => {
							...
							await urbae.reply(from, ceritanyya, id)
								.catch(err => {
									urbae.reply(from, 'Maaf, sistem sedang error', id)
								})
						})
				...
				case prefix + 'wallprogramming':
					...
					urbae.reply(from, mess.wait, id)
					axios.get(`https://cakrayp.herokuapp.com/api/wallpaper/technology?apikey=${cakrayp}`)
						.then(async (res) => {
							const berandom = res.data.result
							
							urbae.sendFileFromUrl(from, berandom, 'img.jpg', 'ichi ni san nya ari lasso', id)
								.catch(() => {
									urbae.reply(from, 'Error', id)
								})
						})
				...
				case prefix + 'ppcouple2':
					...
					urbae.reply(from, mess.wait, id)
					axios.get(`https://cakrayp.herokuapp.com/api/pictures/couple?apikey=${cakrayp}`)
						.then(async (res) => {
				...
				case prefix + 'ppcouple':
					...
					urbae.reply(from, mess.wait, id)
					axios.get(`https://api.dapuhy.xyz/api/randomimage/couple?apikey=${dapuhyapi}`)
						.then(async (res) => {
				...
				case prefix + 'ayatkursi':
					...
					urbae.reply(from, mess.wait, id)
					axios.get(`https://api.dapuhy.xyz/api/islam/ayatkursi?apikey=${dapuhyapi}`)
						.then(async (res) => {
				...
				case prefix + 'memeindo':
					...
					await axios.get(`https://api.zeks.me/api/memeindo?apikey=${apikeyvinz}`).then(res => {
						urbae.sendFileFromUrl(from, `${res.data.result}`, 'image.jpg', 'Done...'
, id)
						console.log('Success')
					})
						.catch((err) => {
				...
				case prefix + 'darkjokes':
					...
					await axios.get(`https://api.zeks.me/api/darkjokes?apikey=${apikeyvinz}`).then(res => {
						urbae.sendFileFromUrl(from, `${res.data.result}`, 'image.jpg', 'Done...', id)
					})
						.catch((err) => {
							console.log(err)
						})
				...
				case prefix + 'stalktwitter':
					...
					axios.get(`https://api.lolhuman.xyz/api/twitter/${usernya}?apikey=${lolhuman}`)
						.then(async (res) => {
							...
							await urbae.sendFileFromUrl(from, res.data.result.profile_picture, 'img.jpg', cptntw, id)
								.catch(() => {
									urbae.reply(from, 'Error', id)
								})
						})
				...
				case prefix + 'lirik':
					...
					axios.get(`https://zekais-api.herokuapp.com/lirik?query=${body.slice(7)}&apikey=${zekais}`)
						.then(async (res) => {
							if (res.data.status == false) return urbae.reply(from, 'Lirik yang kamu cari tidak ada', id)
							await urbae.sendFileFromUrl(from, res.data.thumb, 'thumb.jpg', `Judul : ${res.data.title}\nPenyanyi : ${res.data.author}\nLirik : ${res.data.lirik}`, id)
						})
						.catch(err => {
							console.log(err)
							urbae.reply(from, err.message, id)
				...
				case prefix + 'chord':
					...
					break
				case prefix + 'ssweb':
					if (args.length == 0) return urbae.reply(from, `Kirim perintah *${prefix}ssweb [link website]\nContoh: ${prefix}ssweb2 https://instagram.com/demo_ngki`, id)
					const webss = body.slice(7)
					urbae.reply(from, mess.wait, id)
					await urbae.sendFileFromUrl(from, `https://api.dapuhy.xyz/api/others/ssweb?url=${webss}&apikey=${dapuhyapi}`, 'img.jpg', `nih screenshot-an ${webss} nya`, id)
					break
				case prefix + 'fb3':
                ...
                .then(async(res) => {
                    await urbae.sendFileFromUrl(from, `${res.result.url}\n\n*Setelah vidio dikirim dimohon berterimakasih*\n*Gak makasih = Block!!*\n\nBy : BloodSword`, '', '', id)
                    .catch(() => {
                        urbae.reply(from, `Error...`, id)
                    })
                })
				...
				case prefix + 'twitter':
					...
					axios.get(`https://zenzapi.xyz/downloader/twitter?url=${anjayx}&apikey=${zenzapi}`)
						.then(async (res) => {
							await urbae.sendFileFromUrl(from, res.data.result.HD, '', `*caption: ${res.data.result.desc}*`, id)
								.catch(() => {
									urbae.reply(from, 'error njing', id)
								})
						})
				...
				case prefix + 'joox':
					...
					axios.get(`https://zenzapi.xyz/downloader/joox?query=${body.slice(6)}&apikey=${zenzapi}`)
						.then(async (res) => {
							await urbae.sendFileFromUrl(from, `${res.data.result[0].img}`, 'img.jpg', `「 *JOOX* 」\n\n*Judul :* ${res.data.result[0].lagu}\n*Penyanyi :* ${res.data.result[0].penyanyi}\n*Album :* ${res.data.result[0].album}\n*Publish :* ${res.data.result[0].publish}`)
							await urbae.sendFileFromUrl(from, `${res.data.result[0].mp3Link}`, '', '', id)
							const liruk = `${res.data.lirik[0].result}`
				...
				case prefix + 'igstory2':
					...
					urbae.reply(from, mess.wait, id)
					axios.get(`https://api.dapuhy.xyz/api/socialmedia/igstory?username=${usernamee}&apikey=${dapuhyapi}`)
						.then(async (res) => {
				...
				case prefix + 'javhd':
					...
					urbae.reply(from, mess.wait, id)
					const javapi = await axios.get(`https://api.dapuhy.xyz/api/search/javhdd?query=${carijav}&apikey=${dapuhyapi}`)
				...
				case prefix + 'javporn':
					...
					urbae.reply(from, mess.wait, id)
					const javpornapi = await axios.get(`https://api.dapuhy.xyz/api/search/javhdporn?query=${cariporn}&apikey=${dapuhyapi}`)
				...
				case prefix + 'exec':
					...
					oz.execCommand(q).then((res) => {
						urbae.reply(from, `> root@BloodSword:~ # ${res}`, id)
					}).catch(err => {
						return urbae.reply(from, `> root@BloodSwordXz:~ # ${err}`, id)
						//console.log("os >>>", err);
					})
					break
				case prefix + 'play3':
...
if (args.length == 0) return urbae.reply(from, `Untuk mencari lagu dari youtube\n\nPenggunaan: ${prefix}play judul lagu`, id)
				...
				case prefix + 'shortlink':
					...
					axios.get(`https://api.dapuhy.xyz/api/others/tinyurl?url=${body.slice(11)}&apikey=${dapuhyapi}`).then(res => {
				...
				case prefix + 'pkick':
					if (!isGroupMsg) return urbae.reply(from, 'Maaf, perintah ini hanya dapat dipakai didalam grup!', id)
					if (!isGroupAdmins && !isOwnerB) return urbae.reply(from, 'Gagal, fitur ini hanya bisa di gunakan oleh Admin Grup!!', id)
				...
				case prefix + 'promote':
					if (!isGroupMsg) return urbae.reply(from, 'Maaf, perintah ini hanya dapat dipakai didalam grup!', id)
					if (!isGroupAdmins) return urbae.reply(from, 'Gagal, fitur ini hanya bisa di gunakan oleh Admin Grup!!', id)
...
*Text : ${swrt}*`
				...
				case prefix + 'artimimpi':
					...
					try {
						const resp = await axios.get('https://api.dapuhy.xyz/api/fun/artimimpi?mimpi=' + body.slice(10) + '&apikey=' + dapuhyapi)
						if (resp.data.error) return urbae.reply(from, resp.data.error, id)
	...
	if (isLimit(serial)) return urbae.reply(from, `_Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}limit Untuk Mengecek Kuota Limit Kamu_`, id)        
					...
					axios.get(`https://cakrayp.herokuapp.com/api/gabut?apikey=${cakrayp}`)
						.then(async (res) => {
							...
							await urbae.reply(from, gabt, id)
								.catch(err => {
									urbae.reply(from, 'Maaf, sistem sedang error', id)
								})
						})
				...
				case prefix + 'sfile':
					...
					await urbae.reply(from, mess.wait, id)
					try {
						const becon = await axios.get(`https://api.dapuhy.xyz/api/search/sfile?query=${cariconfig}&apikey=${dapuhyapi}`)
...
_Desc di update oleh : @${chat.groupMetadata.descOwner.replace('@c.us', '')} pada *${moment(chat.groupMetadata.descTime * 1000).format('dddd, DD MMMM YYYY')}* pukul ${moment(chat.groupMetadata.descTime * 1000).format('HH:mm:ss')}_`)
				...
				case prefix + 'grupbot':
				case prefix + 'gcbot':
					const ch = `https://chat.whatsapp.com/DjjHrEWoG6rKnrF5WYvIZ1\n\nSkuyy joinn`
				...
				case prefix + 'math':
				case prefix + 'mtk':
					if (args.length === 3) return urbae.reply(from, `[❗] Kirim perintah *${prefix}math [ Angka ]*\nContoh : ${prefix}math 12 * 12\n*NOTE* :\n- Untuk Perkalian Menggunakan *\n- Untuk Pertambahan Menggunakan +\n- Untuk Pengurangan Mennggunakan -\n- Untuk Pembagian Menggunakan /`)
                        const mtkk = body.slice(5)
                        if (typeof Math_js.evaluate(mtkk) !== "number") {
                        urbae.reply(from, `"${mtkk}", bukan angka!\n[❗] Kirim perintah *${prefix}math [ Angka ]*\nContoh : ${prefix}math 12 * 12\n*NOTE* :\n- Untuk Perkalian Menggunakan *\n- Untuk Pertambahan Menggunakan +\n- Untuk Pengurangan Mennggunakan -\n- Untuk Pembagian Menggunakan /`, id)
                    } else {
                        urbae.reply(from, `*Hasil :*\n_${mtkk} = ${Math_js.evaluate(mtkk)}_`, id)
                    }
                    break
				case prefix + 'twister':
...
if (args.length == 0) return urbae.reply(from, `untuk Menghitung WR MLBB, Contoh : ${prefix}hitungwr 50|60|90`, id)
const wr1 = arg.split('|')[0]
const wr2 = arg.split('|')[1]
const wr3 = arg.split('|')[2]
const URL = `https://zenzapi.xyz/api/information/hitungwr?apikey=${zenzapi}&text=${wr1}&text2=${wr2}&text3=${wr3}`
console.log(URL)
axios.get(URL).then(res => {
    ...
    urbae.reply(from, wrnya, id)
				...
				case prefix + 'translate':
					...
					await axios.get(`https://zekais-api.herokuapp.com/translate?lang=${suway1}&text=${suway2}&apikey=${zekais}`).then(res => {
